...
public class SerialisatieTest extends TestCase {
    ...
    public void testOpslag() {
        ...
        // todo ST nummering personen zit er 1 naast (uncomment hieronder) [gefixt]
        ...
        // todo ST nummering gezinnen zit er 1 naast (uncomment hieronder) [gefixt]
        assertEquals("nummering van gezinnen onjuist", adm.aantalGeregistreerdeGezinnen() + 1, rosaEnJan.getNr());

        // todo ST Personen in obs. gez. zit er 1 naast (uncomment 2rgls hieronder) [gefixt]
