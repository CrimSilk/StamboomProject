...
public class Gezin  implements java.io.Serializable {
    ...
    public String beschrijving() {
        ...
        String data = nr + " " + ouder1.getNaam();
        if(ouder2 != null)
        {
            data += " met " + ouder2.getNaam();
        }
        
        if(huwelijksdatum != null)
        {
            data += " " + StringUtilities.datumString(huwelijksdatum);
        }
    ...
    public boolean heeftGescheidenOudersOp(Calendar datum) {
        ...
        if(scheidingsdatum.before(datum) || scheidingsdatum.equals(datum))
        {
            return true;
        }
